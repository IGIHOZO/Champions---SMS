...
<!--             <li><a href="actions/register/employee"><i class="fa fa-circle-o"></i>New Employee</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="stock"><i class="fa fa-circle-o"></i>Stock</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../actions/purchase"><i class="fa fa-circle-o"></i>Purchases</a></li>
            <li><a href="../actions/import"><i class="fa fa-circle-o"></i>Imports</a></li>
            <li><a href="../actions/expense"><i class="fa fa-circle-o"></i>Expenses</a></li>
          </ul>
        </li>
<!--         <li class="treeview">
          <a href="#">

...
<!--           <ul class="treeview-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="warehouse"><i class="fa fa-circle-o"></i> To WareHouse</a></li>
            <!-- <li><a href="head"><i class="fa fa-circle-o"></i>To Admin-Stock</a></li> -->
            <li><a href="branch"><i class="fa fa-circle-o"></i>To Sub-Stock</a></li>
          </ul>
        </li>

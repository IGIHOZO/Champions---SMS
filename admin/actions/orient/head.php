...
<style type="text/css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Orient Products
        <small><b><u>ADMIN Stock</u></b></small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="modal-dialog" style="min-width: 40%" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" style="font-weight: bold;font-size: 20px;" id="exampleModalLabel">Orient Products | AdminStock</h5>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select style="width: 100%!important;" class="form-control" id="warehouses" style="font-weight: lighter;"></select>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select style="width: 100%!important;" class="form-control" id="product" style="font-weight: lighter;" disabled>
        ...
        <!-- /.col (right) -->
            ...
            <div class="modal-footer">
              <div class="form-group">
                ...
                <div class="input-group">
                  <button class="btn btn-success" style="font-weight: bold;" id="OrientProductsToHeadStock">OK, Orient</button>
                </div>
                <a href="branch" style="float:right;" class="btn btn-primary" id="Next">Next</a>
                <!-- /.input group -->
              </div>
            </div>
          <!-- </form> -->
          ...
          <div class="box" style="margin-left: 0.5%">
            <div class="box-body">
              <a class="btn btn-success" style="font-weight: bolder;">Export Excel</a>
                <a style="float:right;" class="btn btn-primary" id="Next" data-toggle="modal" id="newGoalBtn" data-target="#newRequestModal">Orient</a>
...
<script>
  ...
  $(document).ready(function(){
      ...
      // var available_products_in_main_stock = true;
      // $.ajax({url:"../../../main/view.php",
      //   type:"POST",data:{available_products_in_main_stock:available_products_in_main_stock},cache:false,success:function(res){  
...
$("#warehouses").change(function(){
  ...
  var ProductsOfWarehouse = true;
      $.ajax({url:"../../../main/view.php",
        type:"POST",data:{ProductsOfWarehouse:ProductsOfWarehouse,warehouse:warehouse},cache:false,success:function(res){  
          var res = JSON.parse(res);
          if (res.found===1) {
              $("#product").html("");
            for (const key in res.res) {
              $("#product").attr("disabled",false);
              $("#product").append("<option value='"+res.res[key].ProductId+"'>"+res.res[key].ProductName+"</option>");
            }
          }else{
      ...
      $.ajax({url:"../../../main/view.php",
        type:"POST",data:{available_warehouses:available_warehouses},cache:false,success:function(res){  
          ...
          // console.log(res.found);
          if (res.found===1) {
              $("#warehouses").append("<option value=''> Select Warehouse</option>");
            for (const key in res.res) {
...
$("#product").change(function(){
  ...
  var IsProductBox = true;
      ...
      var headsStockProducts = true;
      $.ajax({url:"../../../main/view.php",
        type:"POST",data:{headsStockProducts:headsStockProducts},cache:false,success:function(res){  
          var res = JSON.parse(res);
          console.log(res.found);
          if (res.found===1) {
            var cnt = 1;
            for (const key in res.res) {
              // console.log(res.res[key]);
              $("#report_div").append("<tr> <td>"+cnt+".</td> <td>"+res.res[key].ProductName+"</td> <td>"+res.res[key].ProductCategory+"</td><td>"+res.res[key].IsProductBox+"</td><td>"+res.res[key].Qnt+"</td> <td>"+res.res[key].ProductBoxPieces+"</td><td>"+res.res[key].ProductDate+"</td> </tr>");
              cnt++;
            }
          }else{

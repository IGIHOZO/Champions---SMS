		...
		if ($sel->rowCount()>=1) {
			...
			while ($ft_sel = $sel->fetch(PDO::FETCH_ASSOC)) {
				...
				if ($emp==0) {
					switch ($sortby) {
						case 'Price':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY stockout.SoldPrice");
							break;
						case 'Date':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY stockout.StockOutDate");
								break;
						case 'Member':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY employees.EmployeeNames");
							break;
						case 'Stock':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY branches.BranchName");
								break;
						case 'Payment':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY stockout.PaymentWay");
							break;
						case 'Client':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY stockout.ClientName");
							break;
						case 'Company':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY stockout.CompanyName");
							break;
						case 'Item':
							$ssel = $con->prepare("SELECT * FROM employees,products,branches,stockout WHERE branches.BranchId=stockout.BranchId AND products.ProductId=stockout.ProductId AND employees.EmployeesId=stockout.MemberId AND stockout.BranchId='$branch' ORDER BY products.ProductName");
							break;

...
<script>
  ...
  $(function () {
      ...
      $.ajax({url:"../../main/view.php",
        type:"POST",data:{GeneralSallesReportBranch:GeneralSallesReportBranch,emp:emp},cache:false,success:function(res){  
...
$("#dtto").change(function(){
  ...
  if(dtFrom!='' && dtTo!=''){
    ...
    var GeneralSallesReportRangeBranch = true;
      $.ajax({url:"../../main/view.php",
        type:"POST",data:{GeneralSallesReportRangeBranch:GeneralSallesReportRangeBranch,dtFrom:dtFrom,dtTo:dtTo,emp:emp},cache:false,success:function(res){  
          var res = JSON.parse(res);
          // console.log(res.res);
          if (res.found===1) {
            for (const key in res.res) {
